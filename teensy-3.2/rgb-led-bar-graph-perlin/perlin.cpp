...
void Perlin::next (uint8_t *levels)
{
  int32_t x, y;
  uint16_t sx, sy;
  int32_t n1, n2;
...
//---------------------------------------------------------------------------------------------
// noise -- fixed point perling noise implementation
//
...
void Perlin::translate_hue (int16_t hue, uint8_t *rgb)
{
  uint8_t hi, lo;
  uint8_t r, g, b;
